(function(){
  ...
  function shouldRunInfoTemplate(){ return normalPath()==='/info-page-template'; }
  ...
  function footerLinks(C){
    ...
    return ''+
      ...
      '<a class="is-active" aria-current="page" href="'+esc(footer.infoTemplateUrl || '/info-page-template')+'">Info page template</a>';
  }
